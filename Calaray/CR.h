...
func Sin(input)
{
	float out = CR.Math.Sin(input)
	return out
}
// Trigonometric function Cos
func Cos(input)
{
	float out = CR.Math.Cos(input)
	return out
}
// Trigonometric function Tan
func Tan(input)
{
	float out = CR.Math.Tan(input)
	return out
}
...
func Round(input)
{
	float out = CR.Math.Round(input)
	return out
}
// Linearly interpolates between a and b by t
func Lerp(a, b, t)
{
	float out = CR.Math.Lerp(a, b, t)
	return out
}
// Get absolute value of x
func Abs(x)
{
	float out = CR.Math.Abs(x)
	return out
}
...
func Perm(n, r)
{
    if n < 0 
    {
        CR.System.PrintLine("n must be superior or equal to 0")
        return -1
    }
    if r < 0
    {
        CR.System.PrintLine("r must be superior or equal to 0")
        return -1
    }
    if r > n
    {
        CR.System.PrintLine("r must be inferior or equal to n")
        return -1
    }
